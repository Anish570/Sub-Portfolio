...
const Profile = () => {
  return (
    <div className=' flex items-center flex-col'>
      <img src="https://anishgtm.netlify.app/assets/profile-pic.png" alt="hello" className='m-2 w-[180px] h-[180px] md:w-[180px] md:h-[180px] border-[2px] border-black dark:border-gray-300 rounded-[12px]' />
